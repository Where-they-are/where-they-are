...
const serverClient = new ServerClient({ baseUrl: ENV.NEXT_PUBLIC_SERVER_BASE_URL });
    ...
    <div className="container mx-auto max-w-3xl px-4 py-2">
      ...
      <div className="grid gap-6">
        <section className="rounded-lg border p-4">
          ...
          <p className="mt-2 text-muted-foreground text-sm">{ENV.NEXT_PUBLIC_SERVER_BASE_URL}</p>
        </section>
      </div>
    </div>
  );
